...
function linkLabelFor(url) {
  ...
  if (url.includes("ai.oliverms.com")) return "Open ai.oliverms.com";
  if (url.includes("nook.oliverms.com")) return "Open nook.oliverms.com";
  if (url.includes("oliverms.com")) return "Open live site";
  return "View project";
}
